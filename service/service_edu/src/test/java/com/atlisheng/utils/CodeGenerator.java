...
public class CodeGenerator {
    ...
    public void CodeGenerate() {
        ...
        //XXX
        //注意找办法把绝对路径搞成相对路径
        gc.setOutputDir("E:\\JavaStudy\\project\\ol_edu\\vpc-ol-edu\\service\\service_edu" + "/src/main/java");
        ...
        //两个结合生成包名"com.atlisheng.eduservice"
        pc.setParent("com.atlisheng");
        pc.setModuleName("eduservice"); //模块名

        //大包"com.atlisheng.eduservice"下的子包com.atlisheng.eduservice.controller
        ...
        //strategy.setInclude("edu_chapter","edu_course","edu_course_description","edu_video");//有多张表用可变长度参数囊括
        strategy.setInclude("edu_comment");//有多张表用可变长度参数囊括
