...
public class CodeGenerator {
    ...
    public void CodeGenerate() {
        ...
        //XXX
        //注意找办法把绝对路径搞成相对路径
        gc.setOutputDir("E:\\JavaStudy\\project\\ol_edu\\vpc-ol-edu\\service\\service_order" + "/src/main/java");
        ...
        //两个结合生成包名"com.atlisheng.eduorder"
        ...
        strategy.setInclude("edu_pay_log");//有多张表用可变长度参数囊括
