            ...
            <div>
                ...
                <aside class="c-attr-wrap">
                    <section class="ml20 mr15">
                        ...
                        <!--如果课程是免费的，显示立即观看；如果课程是收费的但还是已经支付过了，显示立即观看；如果课程没有购买，且不是免费课程、显示立即购买-->
                                            ...
                                            <section class="question-list lh-bj-list pr">
                                                <ul class="pr10">
                                                    <li v-for="(comment,index) in data.comments" v-bind:key="index">
                                                        ...
                                                        <div class="of mt5">
                                                            <span class="f2">
                                                                <font class="fsize12 c-999 ml5">第{{(index+1)+((data.curPage-1)*limit)}}层</font>
                                                            </span>
                                                            <span class="fr">
...
export default {
    //一进入页面就要判断课程是否购买，如果异步调用查询课程是否购买页面可能会出问题，加载页面时进行参数判断可能hi存在问题
    ...
    methods:{
        ...
        //获取课程信息
        initCourseInfo(){
            course.getCourseInfoByCourseId(this.courseId).then(response => {
